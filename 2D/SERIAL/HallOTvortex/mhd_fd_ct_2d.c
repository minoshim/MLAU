...
#endif
      {
	bc2d(&hx[0],nx,ny,xoff,yoff,0,0,0,0);
	bc2d(&hy[0],nx,ny,xoff,yoff,0,0,0,0);
	bc2d(&hz[0],nx,ny,xoff,yoff,0,0,0,0);
      }
...
#endif
      {
	bc2d(&d2u[0*nxy],nx,ny,xoff,yoff,0,0,0,0);
	bc2d(&d2u[1*nxy],nx,ny,xoff,yoff,0,0,0,0);
	bc2d(&d2u[2*nxy],nx,ny,xoff,yoff,0,0,0,0);
      }
#endif
