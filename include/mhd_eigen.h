...
inline void mhd_eigen_mi(double ro, double vx, double vy, double vz, double bx, double by, double bz, double pr, double gamma,
			 double *al1, double *al2, double *al3, double *al4, double *al5, double *al6, double *al7,
			 double *l1, double *l2, double *l3, double *l4, double *l5, double *l6, double *l7, 
			 double *r1, double *r2, double *r3, double *r4, double *r5, double *r6, double *r7)
/* Calculate approximate eigenvectors for non-conservative form by Miyoshi-san */
/* Consider fast and alfven modes, slow mode is ignored */
/* Outputs: */
...
/* r?: right eigenvectors (column vectors) */
{
  ...
  double icf2=1.0/cf2;
  double icf2h=0.5*icf2;
  double ircfh=0.5/rcf;
  double byh=0.5*by;
  double bzh=0.5*bz;
...
inline void mhd_m_reconst(const double *ro, const double *vx, const double *vy, const double *vz,
			  const double *by, const double *bz, const double *pr,
			  double bx, double gamma, const int s,
			  double *ul, double *ur,
			  void (*func_lr)(const double*, double*, double*))
