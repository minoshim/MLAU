...
#endif
      {
	bc3d(&cx[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
	bc3d(&cy[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
	bc3d(&cz[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
      }
...
#endif
      {
	bc3d(&dvx[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
	bc3d(&dvy[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
	bc3d(&dvz[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
      }
...
#pragma simd
    ...
    /* Boundary condition */
    bc3d(&ro[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
    bc3d(&mx[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
    bc3d(&my[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
    bc3d(&mz[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
    bc3d(&en[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,0,0);
    bc3d(&bx[0],nx,ny,nz,xoff,yoff,zoff,1,0,0,0,0,0);
    bc3d(&by[0],nx,ny,nz,xoff,yoff,zoff,0,0,1,0,0,0);
    bc3d(&bz[0],nx,ny,nz,xoff,yoff,zoff,0,0,0,0,1,0);
  }
